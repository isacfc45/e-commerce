...
export default function AreaItemCarrinho(props: AreaItemCarrinhoProps) {
  return (
    <div className="flex items-center gap-5 bg-gray-300 rounded-md overflow-hidden ">
      ...
      <div className="flex flex-col justify-center flex-1">
        <span className="text-cl font-bold">{props.item.produto.nome}</span>
        <span className="text-sm text-gray-600">
          {props.item.produto.descricao}
        </span>
        <div className="flex items-center gap-2 mt-2 text-gray-600 text-lg font-bold">
      ...
      <div className="flex gap-2 items-center px-5">
        ...
        <span className="flex px-4 py-2 rounded-md bg-gray-400">
